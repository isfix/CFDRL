"""
Phase 27: Notebook Generator.
Creates colab_training.ipynb with all Phase 27 changes (DDQN, SAE, vol fix, etc).
"""
import json
import os
...
def create_notebook():
    ...
    # Cell 0: Title
    cells.append({
        "cell_type": "markdown", "id": "title", "metadata": {}, "source": [
            "# Phase 27: Research-Driven Trading System — Colab Training\n",
            "\n",
            "**Fixes Applied:**\n",
            "- 🔴 P0: True DDQN (target net, soft-update τ=0.005)\n",
            "- 🔴 P0: Corrected volatility scaling (1/vol inverse)\n",
            "- 🟠 P1: Sequence 240, No warm-start, Trade-only Sharpe\n",
            "- 🟡 P2: SAE encoder (21→12 features), LR scheduler, ε=0.98\n",
            "\n",
    ...
    # Cell 1: Mount + Deps
    cells.append({
        "cell_type": "code", "execution_count": None, "id": "setup", "metadata": {}, "outputs": [], "source": [
    ...
    cells.append({
        "cell_type": "code", "execution_count": None, "id": "config", "metadata": {}, "outputs": [], "source": [
            ...
            "\n",
            "print(f'Config: {Settings.INPUT_DIM} feats → SAE({Settings.SAE_DIM}) → LSTM({Settings.HIDDEN_DIM}) → {Settings.OUTPUT_DIM} actions')\n",
            "print(f'Device: {torch.device(\"cuda\" if torch.cuda.is_available() else \"cpu\")}')"
        ]
    })
    
    # Cell 3: QNetwork with SAE
    cells.append({
        "cell_type": "code", "execution_count": None, "id": "brain", "metadata": {}, "outputs": [], "source": [
    ...
    # Cell 4: PER
    cells.append({
        "cell_type": "code", "execution_count": None, "id": "per", "metadata": {}, "outputs": [], "source": [
            "class SumTree:\n",
    ...
    cells.append({
        "cell_type": "code", "execution_count": None, "id": "features", "metadata": {}, "outputs": [], "source": [
    ...
    # Cell 6: Dataset
    cells.append({
        "cell_type": "code", "execution_count": None, "id": "dataset", "metadata": {}, "outputs": [], "source": [
    ...
    # Cell 7: Training function with DDQN
    cells.append({
        "cell_type": "code", "execution_count": None, "id": "train_fn", "metadata": {}, "outputs": [], "source": [
            ...
            "\n",
            "        # P1: No warm-start — fresh network per window\n",
    ...
    # Cell 8: Execute
    cells.append({
        "cell_type": "code", "execution_count": None, "id": "execute", "metadata": {}, "outputs": [], "source": [
            "# ⚡ SELECT PAIRS:\n",
            "pairs = ['EURUSD']\n",

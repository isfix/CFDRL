...
def create_notebook():
    ...
    cells.append(md_cell([
        ...
        "\n",
        "Upload your `{PAIR}.csv` M5 data to `/content/`. Set `PAIR` in Settings to match.\n",
        "\n",
        "Supported: EURUSD, GBPUSD, AUDUSD, NZDUSD, USDCAD, USDCHF, USDJPY, XAUUSD, NAS100, US30"
    ]))
    ...
    cells.append(code_cell([
        ...
        "    EPISODE_LENGTH = 2000      # ~21 days M15 — enough for trade lifecycle\n",
        "    EPISODES_PER_EPOCH = 50    # 50x2000 = 100k steps/epoch\n",
        "\n",
        "    # ==== PAIR CONFIGURATION ====\n",
        "    # Change PAIR to train a different symbol\n",
        "    PAIR = 'EURUSD'  # <-- CHANGE THIS\n",
        "\n",
        "    PAIR_CONFIGS = {\n",
        "        'XAUUSD':  {'scaling_factor': 5.0,     'spread': 0.20,    'contract_size': 100,    'reward_type': 'trend'},\n",
        "        'EURUSD':  {'scaling_factor': 10000.0, 'spread': 0.00010, 'contract_size': 100000, 'reward_type': 'mean_reversion'},\n",
        "        'GBPUSD':  {'scaling_factor': 10000.0, 'spread': 0.00020, 'contract_size': 100000, 'reward_type': 'trend'},\n",
        "        'AUDUSD':  {'scaling_factor': 10000.0, 'spread': 0.00015, 'contract_size': 100000, 'reward_type': 'mean_reversion'},\n",
        "        'NZDUSD':  {'scaling_factor': 10000.0, 'spread': 0.00020, 'contract_size': 100000, 'reward_type': 'mean_reversion'},\n",
        "        'USDCAD':  {'scaling_factor': 10000.0, 'spread': 0.00020, 'contract_size': 100000, 'reward_type': 'mean_reversion'},\n",
        "        'USDCHF':  {'scaling_factor': 10000.0, 'spread': 0.00015, 'contract_size': 100000, 'reward_type': 'mean_reversion'},\n",
        "        'USDJPY':  {'scaling_factor': 100.0,   'spread': 0.010,   'contract_size': 100000, 'reward_type': 'trend'},\n",
        "        'GBPJPY':  {'scaling_factor': 100.0,   'spread': 0.020,   'contract_size': 100000, 'reward_type': 'trend'},\n",
        "        'EURJPY':  {'scaling_factor': 100.0,   'spread': 0.015,   'contract_size': 100000, 'reward_type': 'trend'},\n",
        "        'AUDJPY':  {'scaling_factor': 100.0,   'spread': 0.015,   'contract_size': 100000, 'reward_type': 'trend'},\n",
        "        'CADJPY':  {'scaling_factor': 100.0,   'spread': 0.015,   'contract_size': 100000, 'reward_type': 'trend'},\n",
        "        'EURGBP':  {'scaling_factor': 10000.0, 'spread': 0.00015, 'contract_size': 100000, 'reward_type': 'mean_reversion'},\n",
        "        'EURAUD':  {'scaling_factor': 10000.0, 'spread': 0.00025, 'contract_size': 100000, 'reward_type': 'trend'},\n",
        "        'GBPAUD':  {'scaling_factor': 10000.0, 'spread': 0.00030, 'contract_size': 100000, 'reward_type': 'trend'},\n",
        "        'EURCAD':  {'scaling_factor': 10000.0, 'spread': 0.00025, 'contract_size': 100000, 'reward_type': 'mean_reversion'},\n",
        "        'GBPCAD':  {'scaling_factor': 10000.0, 'spread': 0.00030, 'contract_size': 100000, 'reward_type': 'trend'},\n",
        "        'NAS100':  {'scaling_factor': 1.0,     'spread': 1.5,     'contract_size': 1,      'reward_type': 'trend'},\n",
        "        'US30':    {'scaling_factor': 1.0,     'spread': 3.0,     'contract_size': 1,      'reward_type': 'trend'},\n",
        "    }\n",
        "\n",
        "    # Auto-resolve from PAIR\n",
        "    _pair_cfg = PAIR_CONFIGS[PAIR]\n",
        "    SCALING_FACTOR = _pair_cfg['scaling_factor']\n",
        "    CSV_PATH = f'/content/{PAIR}.csv'\n",
        "\n",
        "print(f'Settings loaded: {Settings.PAIR} | SF={Settings.SCALING_FACTOR} | {Settings.INPUT_DIM} features, {Settings.OUTPUT_DIM} actions')\n",
    ]))
    ...
    # ============================================================
    cells.append(md_cell(["## Load & Prepare Data"]))
    ...
    # CELL 5: PER Buffer
    # ============================================================
    cells.append(md_cell(["## PER (Prioritized Experience Replay)"]))
    ...
    # ============================================================
    # CELL 6: QNetwork (Position-Aware)
    # ============================================================
    cells.append(md_cell(["## Position-Aware QNetwork"]))
    ...
    # ============================================================
    # CELL 7: Trading Environment
    # ============================================================
    cells.append(md_cell(["## Trading Environment (Sequential, Position-Aware)"]))
    ...
    # CELL 9: Run Training
    # ============================================================
    cells.append(md_cell(["## Run Training"]))
    ...
    # ============================================================
    cells.append(md_cell(["## Download Model"]))
